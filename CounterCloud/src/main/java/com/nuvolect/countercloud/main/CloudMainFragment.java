...
public class CloudMainFragment extends Fragment {
    ...
    RelativeLayout m_cloudSummaryRl;
    Activity m_act;
    Context m_ctx;
    boolean m_wasPaused;
    ...
    AsyncTask<Void, Void, Integer> m_appSurveyAsyncTask;
    ...
    public void onPause() {
        ...
        if( m_appSurveyAsyncTask != null )
            m_appSurveyAsyncTask.cancel( true );
    ...
    public void resetCloudSummary(){
        ...
        if(PermissionUtil.canAccessReadContacts(m_act)) {
            ...
            m_appSurveyAsyncTask = new AppSurveyAsync().execute();
        }
        else
            PermissionUtil.requestReadWriteContacts(m_act, 222);
    }
    ...
    private class QueryCloudAsync extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void v) {
            ...
            ShowTips.getInstance(m_act).embeddedShowTips();
        }
    }
    ...
    private void buildView(){
        ...
        // Dynamically build a layout of a RelativeLayout
        m_cloudSummaryRl = (RelativeLayout) m_rootView.findViewById(R.id.cloud_main_summaryRl);

        // Remove any previous view, we are about ready to replace it
        m_cloudSummaryRl.removeAllViews();
        ...
        m_cloudSummaryRl.addView(dataTable);
        ...
        headingTv.setSoundEffectsEnabled( false);
...
//        iv.setColorFilter(m_searchColor);
    ...
    private class AppSurveyAsync extends AsyncTask<Void, Void, Integer>
    {
        @Override
        protected Integer doInBackground(Void...arg0) {

            return AppSurveyExec.getContactsAppsTotal(m_act);
        }

        @Override
        protected void onPostExecute(Integer contactsAppsTotal) {
