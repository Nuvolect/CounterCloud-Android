...
public class BetterCrypto {
    ...
    public static String decrypt(Context ctx, String encrypted){
        ...
        /**
         * If we got here it means SimpleCrypto was used.  Use it this time and
         * re-encrypt the data into the new algorithm.
         */
        //CRYPTOPATCH BetterCrypto patch, remove next line after transition release
        String clearText = SimpleCrypto.decrypt(ctx, encrypted);
